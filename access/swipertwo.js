...
swiper.on('slideChange', function () {
	...
	if (swiper.realIndex == 0) {
		...
		$('.contentone').css('background', '#D9E3F0');
	}
	...
	if (swiper.realIndex == 1) {
		...
		$('.contentone').css('background', '#EDE3EB');
	}
  ...
  if($('.swiper-slide.passport').length == 5){
    if (swiper.realIndex == 2) {
      ...
      $('html').css('background', '#bcb8cf');
  		$('.contentone').css('background', '#dbd9e6');
  	}
      ...
      $('.contentone').css('background', '#e8f5e4');
  	}
      ...
      $('html').css('background', '#C9D8E7');
      $('.contentone').css('background', '#E4ECF3');
  	}
  ...
  } else if($('.swiper-slide.passport').length == 4 && $('.swiper-slide.passport:eq(2)').children('.contentone').children('.name').html() == 'KBE968639'){
    if (swiper.realIndex == 2) {
  		$('.dit_dot').removeClass('act');
  		var sss = swiper.realIndex + 1;
  		$('.dit_dot:nth-child(' + sss + ')').addClass('act');
...
if($('.covid').length == 1){
  ...
  covid.addEventListener('click', function () {
    ...
    if (j = 1) {
      setTimeout(function () {
        $('.covid > .contentone > .unloaded').css('opacity', '0');
        $('.covid > .contentone > .loaded').css('opacity', '1');
      }, 500);
    }
    ...
    $('.covid > .contentone').css('filter', 'brightness(0.8)');
    setTimeout(function () {
      $('.covid > .contentone').css('filter', 'brightness(1)');
    }, 200);
...
if($('.prava').length == 1){
  ...
  prava.addEventListener('click', function () {
    ...
    $(".vshicon").on('click', function () {
  	...
  	if (l = 1) {
  		setTimeout(function () {
  			$('.prava > .contentone > .unloaded').css('opacity', '0');
  			$('.prava > .contentone > .loaded').css('opacity', '1');
  		}, 500);
  	}
  	...
  	$('.prava > .contentone').css('filter', 'brightness(0.8)');
  	setTimeout(function () {
  		$('.prava > .contentone').css('filter', 'brightness(1)');
  	}, 200);
...
var i = 0
var pssprtt = document.querySelector(".pssprtt");
var playing = false;
pssprtt.addEventListener('click', function () {
	i = i + 1;
  ...
  $(".pshicon").on('click', function () {
	...
	if (i = 1) {
		setTimeout(function () {
			$('.pssprtt > .contentone > .unloaded').css('opacity', '0');
			$('.pssprtt > .contentone > .loaded').css('opacity', '1');
		}, 500);
	}
	...
	$('.pssprtt > .contentone').css('filter', 'brightness(0.8)');
	setTimeout(function () {
		$('.pssprtt > .contentone').css('filter', 'brightness(1)');
	}, 200);
...
nlgi.addEventListener('click', function () {
  ...
  $(".nshicon").on('click', function () {
	...
	if (n = 1) {
		setTimeout(function () {
			$('.nlgi > .contentone > .unloaded').css('opacity', '0');
			$('.nlgi > .contentone > .loaded').css('opacity', '1');
		}, 500);
	}
	...
	$('.nlgi > .contentone').css('filter', 'brightness(0.8)');
	setTimeout(function () {
		$('.nlgi > .contentone').css('filter', 'brightness(1)');
	}, 200);
...
// } else {
//   isWorking = false;
// $('body').html('<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-contentone: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div class="installName" style="font-size: 20px;font-weight: 600;">Сайт доступен</div><p>Только с мобильных устройств</p></div></div>'); 
// $('body').addClass('nononopage');
// }
